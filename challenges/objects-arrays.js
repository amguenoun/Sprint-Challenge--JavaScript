...
const uni = universities.filter((item) => item.match(/Uni/) !== null);
console.log(uni);
...
*/
//forEach does not return an array - instructions unclear
zooAnimals.forEach((item) => console.log(`Name: ${item.animal_name} Scientific: ${item.scientific_name}`));
